...
public class Rohankar {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		int sum = 0;
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\prasad.joshi\\CURIS_Automation\\src\\main\\resources\\chromedriver.exe");
	...
	// System.out.println(sum);
		...
		String ActualTotal = driver.findElement(By.xpath("//div[@id='innings_2']//div[text()='Total']/following-sibling::div[1]")).getText();
